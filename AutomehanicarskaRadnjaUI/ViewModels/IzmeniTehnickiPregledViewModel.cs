...
{
    class IzmeniTehnickiPregledViewModel : Screen
    {
        ...
        private TehnickiPregled _selectedTehnickiPregled;

        public IzmeniTehnickiPregledViewModel(TehnickiPregled selectedTehnickiPregled)
        {
            ...
            SelectedTehnickiPregled = selectedTehnickiPregled;

            DatumIVreme = SelectedTehnickiPregled.DatumIVreme;
            SelectedStatus = SelectedTehnickiPregled.Status;
            SelectedAutomobil = _daoAutomobil.FindById(SelectedTehnickiPregled.AutomobilAutomobilId);
            SelectedGaraza = _daoGaraza.FindById(SelectedTehnickiPregled.GarazaGarazaId);
            SelectedZaposleni = _daoZaposleni.FindById(SelectedTehnickiPregled.ZaposleniZaposleniId);
            Opis = selectedTehnickiPregled.Opis;

            Console.WriteLine("Selected tehnicki pregled is " + SelectedTehnickiPregled.TehnickiPregledId);
        }
        ...
        {
            get { return _selectedTehnickiPregled; }
            set { _selectedTehnickiPregled = value; }
        }

        public void Izmeni()
        {

            SelectedTehnickiPregled.DatumIVreme = DatumIVreme;
            SelectedTehnickiPregled.Opis = Opis;
            SelectedTehnickiPregled.GarazaGarazaId = SelectedGaraza.GarazaId;
            SelectedTehnickiPregled.ZaposleniZaposleniId = SelectedZaposleni.ZaposleniId;
            SelectedTehnickiPregled.AutomobilAutomobilId = SelectedAutomobil.AutomobilId;
            SelectedTehnickiPregled.Status = SelectedStatus;

            _dao.Update(SelectedTehnickiPregled);
        }
    }
}
